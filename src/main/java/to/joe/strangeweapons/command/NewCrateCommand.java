...
public class NewCrateCommand implements CommandExecutor
{
    ...
    /*
     * series series quantity series quantity target
     */
    public boolean onCommand(CommandSender sender, Command cmd, String label, String[] args)
    {
        ...
        try
        {
            ...
            { // And here they forgot it.
                sender.sendMessage(ChatColor.RED + "Specify a crate series");
                return true;
            }

            if (args.length > 1)
            { // Try for the quantity. This is optional.
        ...
        { // Looks like they left it off, better check to make sure they're not console.
